...
\begin{document}
  ...
  The listing of dependencies was patched as some were uninstallable out of the box because their compiler versions were not directly supported by the used Ubuntu versions at the time (20.04 LTS and 22.04 LTS).
