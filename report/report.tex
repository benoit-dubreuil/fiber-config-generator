...
\begin{document}
  ...
  generation to and single out one according to predefined selection criteria (1), and develop an application that utilises the selected library in order to generate high-level fiber configurations (2).
  ...
  In the first part of the project, it was realised that there was an absence of fiber bundle generation-centric softwares.
  Consequently, non fiber-centric softwares were included in the search and MRI-centric ones were the only group to come close to our project's needs~\cite{descoteauxvalcourtcaron2022othertoolsthanfiberfox}.
  These are automation capability, ergonomics, functional independence, and being coded in Python for simplicity due to the fact that it is the main programming language used within the LINUM~\cite{dubreuil2022inf6200}.
