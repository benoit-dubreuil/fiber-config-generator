...
\begin{document}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../img/sim_gen__v_shape__bad}
    \caption{Unpredictable V-shaped geometric shape fiber bundle generated with Simulation Generator and displayed in MITK Diffusion Fiberfox}
    \label{fig:fig1}
  \end{figure}
