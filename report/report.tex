...
\begin{document}
  ...
  With the aim of simulating 3D microscopy data from output fiber configurations, a point spread function (PSF) was generated using the tool PSF Generator~\cite{kirshnersage2019psfgenerator}.
